...
function shoppingTime(memberId, money) {
  ...
  let buyerMoney = buyer.money;

  for (const item in saleItem) {
    if (buyer.money >= saleItem[item]) {
      buyer.listPurchased.push(item);
      buyer.changeMoney = buyerMoney - saleItem[item];
      buyerMoney = buyer.changeMoney;
    }
  }
